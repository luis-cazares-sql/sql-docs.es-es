...
### <a name="c-dropping-a-temporary-table"></a>C. Quitar una tabla temporal  
 En el siguiente ejemplo se crea una tabla temporal, se comprueba si existe, se quita y se comprueba de nuevo si existe. En este ejemplo no se utiliza la sintaxis **IF EXISTS**, que está disponible a partir de [!INCLUDE[ssSQL15](../../includes/sssql16-md.md)].  
