...
```  
 ...
 En este ejemplo se quita el procedimiento almacenado `dbo.uspMyProc`, si existe, pero no se produce un error si el procedimiento no existe. Esta sintaxis es nueva en [!INCLUDE[ssSQL15](../../includes/sssql16-md.md)].  
