...
**Se aplica a**: desde [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] hasta la [versión actual](../../sql-server/what-s-new-in-sql-server-2016.md) y Azure SQL Managed Instance.
