...
*IF EXISTS*
**Se aplica a**: [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ( [!INCLUDE[ssSQL15](../../includes/sssql16-md.md)] hasta [versión actual](../../sql-server/what-s-new-in-sql-server-2016.md)).
