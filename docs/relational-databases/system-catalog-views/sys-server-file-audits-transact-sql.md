...
|type|**char(2)**|Tipo de auditoría:<br /><br /> SL = registro de eventos de seguridad de NT<br /><br /> AL = registro de eventos de aplicación NT<br /><br /> FL = archivo en el sistema de archivos|  
