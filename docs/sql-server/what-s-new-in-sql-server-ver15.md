...
Para obtener la mejor experiencia con [!INCLUDE[sql-server-2019](../includes/sssqlv15-md.md)], use las [herramientas más recientes](../azure-data-studio/download-azure-data-studio.md).
